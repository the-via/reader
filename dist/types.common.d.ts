...
export declare type KeyboardDictionary = Record<string, DefinitionVersionMap>;
export declare type DefinitionVersion = keyof KeyboardDictionary[keyof KeyboardDictionary];
